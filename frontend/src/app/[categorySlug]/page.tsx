  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <nav className="text-sm text-gray-500 mb-4">
        <Link href="/" className="hover:text-[#5e000e]">Acasa</Link>
        {" / "}
      ...
      <p className="text-gray-500 mb-8">
        {products.data.length} {products.data.length === 1 ? "produs" : "produse"}
      </p>

      {products.data.length === 0 ? (
        <p className="text-gray-500">
          Nu exista produse in aceasta categorie inca.
        </p>
      ) : (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-lg font-bold text-[#5e000e]">
                  {prod.price.toFixed(2)} MDL
                </span>
                {prod.stockQuantity === 0 ? (
                  <span className="text-xs text-red-500">Stoc epuizat</span>
